...
apps[0].servers.push(generateServer('http://server1.cloudA/app', 'cloudA', 1, now, 50));
apps[0].servers.push(generateServer('http://server2.cloudA/app', 'cloudA', 2, now + 10000, 40));
apps[0].servers.push(generateServer('http://server3.cloudA/app', 'cloudA', 3, now + 10000, 30));
apps[0].servers.push(generateServer('http://server4.cloudB/app', 'cloudB', 4, now + 10000, 20));
apps[0].servers.push(generateServer('http://server5.cloudB/app', 'cloudB', 5, now + 10000, 10));
